...
import SalidaCajaScreen from '../Screens/SalidaCajaScreen';
export default class SalidaCajaGridScreen extends React.Component{
    constructor(props) {
        super(props);
        this.LoadMenusData()  
...
{this.state.addRecord !== true && (
  ...
  <ModalControls modalTitle={this.state.modalTitle} hideModal={this._hideModal} isEdit={editFields} saveEdit={this.saveEdit}/>
    ...
    />
      ...
      {this.state.addRecord === true  
        &&(<SalidaCajaScreen navigationValue={this.props.navigation} toggleForm={this._toggleForm}/>)
      }
    </View>
    );
  } 
